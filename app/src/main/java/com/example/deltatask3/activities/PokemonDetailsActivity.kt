...
class PokemonDetailsActivity : AppCompatActivity() {
    private var binding: ActivityPokemonDetailsBinding? = null

    @JvmField
    @Inject
    var pokemonApi: PokemonApi? = null
    private var id = 0
    private var evolutionChainURL: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = pokemon!!.getSprites().front_default
        types
        stats
        species
    ...
    private val evolutionChain: Unit
        private get() {
